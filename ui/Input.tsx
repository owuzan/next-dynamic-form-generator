...
export interface InputProps extends Omit<DefaultProps, "className"> {
  label: string;
  id: string;
  errors?: string[];
}
...
const Input = React.forwardRef(
  (props: InputProps, ref: React.LegacyRef<HTMLInputElement>) => {
    ...
    const inputClasses = classNames(
      "bg-white appearance-none border rounded w-full h-10 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white",
      [
        !!errors.length
